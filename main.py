...
trix = {'চুলকানি': 'itching', 'চামড়া ফুসকুড়ি': 'skin_rash', 'চামড়ার বিশেষ ক্ষত': 'nodal_skin_eruptions',
        ...
        'জিহ্বায় সাদা দাগ': 'patches_in_throat', 'অনিয়মিত চিনির স্তর': 'irregular_sugar_level',
        'কাশি': 'cough',
        ...
        'হলুদ চামড়া': 'yellowish_skin', 'প্রসাব গাঢ়': 'dark_urine', 'বমি বমি ভাব': 'nausea',
        ...
        'রক্ত জমাট': 'congestion', 'বুকে ব্যাথা': 'chest_pain', 'হাত পায়ে দুর্বলতা': 'weakness_in_limbs',
        'বুক ধড়ফড়': 'fast_heart_rate', 'মূত্রনালীতে ত্যাগে ব্যাথা': 'pain_during_bowel_movements',
        'মূত্রনালীর অঞ্চলে ব্যাথা': 'pain_in_anal_region', 'রক্তাক্ত  মল': 'bloody_stool',
        'মলদ্বারে জ্বালাপোড়া': 'irritation_in_anus', 'ঘাড়ে ব্যাথা': 'neck_pain', 'মাথা ঘোরা': 'dizziness',
        'পেশীতে ব্যাথা': 'cramps', 'আঘাত পেয়ে ক্ষত': 'bruising', 'মেদ বেড়ে যাওয়া': 'obesity',
        ...
        'গ্যাস নির্গত': 'passage_of_gases', 'চুলকানি শরীরের ভিতরে': 'internal_itching',
        'বিমর্ষ চেহারা': 'toxic_look_(typhos)', 'বিষণ্ণতা': 'depression', 'খিটখিটেভাব': 'irritability',
        ...
        'প্রসাব খুব ঘন ঘন': 'polyuria', 'পারিবারিক ইতিহাস': 'family_history', 'এজমার থুথু': 'mucoid_sputum',
        ...
        'সূচে সমস্যা': 'receiving_unsterile_injections', 'জ্ঞান নাই': 'coma',
        ...
        'শরীরে পানি': 'fluid_overload', 'রক্তাক্ত মল': 'blood_in_sputum',
...
dis = {
    ...
    'Heart attack': 'হার্ট অ্যাটাক', 'Pneumonia': 'নিউমোনিয়া', 'Cervical spondylosis': 'কোমরের ডিস্ক সমস্যা',
...
def prediction():
    ...
    print(dis.get(*map(str, dt.predict(sample_x))))
    ...
    print(dis.get(*map(str, naive.predict(sample_x))))
    ...
    print(dis.get(*map(str, s.predict(sample_x))))
